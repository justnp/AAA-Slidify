...
slidifyUI(
  sidebarPanel(selectInput(inputId = "scttrafficType",
               ...
               selectInput(inputId = "sctstate",
                label = "Choose a state to compare year:", 
...
```{r opts.label = 'shiny'}
slidifyUI(
  sidebarPanel(selectInput(inputId = "sct1trafficType",
                label = "Select Airport Type",
                choices = c("Domestic", "International"),
                selected = "Domestic")                                          
       ),
  mainPanel(tags$div(id = 'sctChart1', class='shiny-html-output nvd3 rChart'))  
)
```
